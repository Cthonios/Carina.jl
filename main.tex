...
approximation applied to $\C$. Its orthogonal
...
Introduce independent fields $\thbar$, $\ebar$, $\pbar$, $\sbar$ and
constrain them weakly to equal their pointwise counterparts
$\theta$, $\edev$, $p$, $\sdev$ by Lagrange
multipliers that are themselves the work-conjugate fields. The
Hu-Washizu functional is
\begin{equation}
  \label{eq:hw}
  \begin{split}
...
\begin{equation}
  ...
  \;\geq\; \beta > 0,
\end{equation}
and the discrete pairs satisfying its analogue uniformly in $h$
...
\begin{equation}
  ...
  ~R_a(~\varphi) :=
  \int_B \left( \pbar(~\varphi) ~I + \sbar(~\varphi) \right) : \frac{\partial \eps(~X)}{\partial ~\varphi_a} \diff V
  -
  \int_B R ~B \, N_a \diff V
  -
  \int_{\partial_T B} ~T \, N_a \diff S
...
\bibitem[Arnold et~al.(2007)]{Arnold.Falk.Winther:2007}
D.~N. Arnold, R.~S. Falk, and R.~Winther.
\newblock Mixed finite element methods for linear elasticity with weakly imposed symmetry.
\newblock \emph{Mathematics of Computation}, 76:1699--1723, 2007.

\bibitem[Arnold et~al.(2006)]{Arnold.Falk.Winther:2006a}
D.~N. Arnold, R.~S. Falk, and R.~Winther.
\newblock Differential complexes and stability of finite element methods~II: The elasticity complex.
\newblock In D.~Arnold, P.~Bochev, R.~Lehoucq, R.~Nicolaides, and M.~Shashkov, editors, \emph{Compatible Spatial Discretizations}, volume 142 of \emph{IMA Volumes in Mathematics and its Applications}, pages 47--67. Springer, 2006.

\bibitem[Arnold et~al.(2010)]{Arnold.Falk.Winther:2010}
D.~N. Arnold, R.~S. Falk, and R.~Winther.
\newblock Finite element exterior calculus: from Hodge theory to numerical stability.
\newblock \emph{Bulletin of the American Mathematical Society}, 47(2):281--354, 2010.

\bibitem[Arnold et~al.(2008)]{Arnold.Awanou.Winther:2008}
D.~N. Arnold, G.~Awanou, and R.~Winther.
\newblock Finite elements for symmetric tensors in three dimensions.
\newblock \emph{Mathematics of Computation}, 77:1229--1251, 2008.

\bibitem[Danielson(2014)]{Danielson:2014}
K.~T. Danielson.
\newblock Fifteen node tetrahedral elements for explicit methods in nonlinear solid dynamics.
\newblock \emph{Computer Methods in Applied Mechanics and Engineering}, 272:160--180, 2014.

\bibitem[Foulk et~al.(2021)]{Foulk.etal:2021}
J.~W. Foulk~III, J.~T. Ostien, B.~Talamini, M.~R. Tupek, N.~K. Crane, A.~Mota, and M.~G. Veilleux.
\newblock Extending a 10-node composite tetrahedral finite element for solid mechanics.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 122:6939--6967, 2021.

\bibitem[Irving et~al.(2007)]{Irving.etal:2007}
G.~Irving, C.~Schroeder, and R.~Fedkiw.
\newblock Volume conserving finite element simulations of deformable models.
\newblock \emph{ACM Transactions on Graphics}, 26, 2007.

\bibitem[Klaas et~al.(1999)]{Klaas:1999}
O.~Klaas, A.~Maniatty, and M.~S. Shephard.
\newblock A stabilized mixed finite element method for finite elasticity: Formulation for linear displacement and pressure interpolation.
\newblock \emph{Computer Methods in Applied Mechanics and Engineering}, 180:65--79, 1999.

\bibitem[Maniatty et~al.(2002)]{Maniatty:2002}
A.~M. Maniatty, Y.~Liu, O.~Klaas, and M.~S. Shephard.
\newblock Higher order stabilized finite element method for hyperelastic finite deformation.
\newblock \emph{Computer Methods in Applied Mechanics and Engineering}, 191:1491--1503, 2002.

\bibitem[Mota et~al.(2013)]{Mota.etal:2013}
A.~Mota, W.~Sun, J.~T. Ostien, J.~W. Foulk~III, and K.~N. Long.
\newblock Lie-group interpolation and variational recovery for internal variables.
\newblock \emph{Computational Mechanics}, 52:1281--1299, 2013.

\bibitem[Ostien et~al.(2016)]{Ostien.etal:2016}
J.~T. Ostien, J.~W. Foulk~III, A.~Mota, and M.~G. Veilleux.
\newblock A 10-node composite tetrahedral finite element for solid mechanics.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 107:1145--1170, 2016.

\bibitem[Ortiz et~al.(2001)]{Ortiz.Radovitzky.Repetto:2001}
M.~Ortiz, R.~A. Radovitzky, and E.~A. Repetto.
\newblock The computation of the exponential and logarithmic mappings and their first and second linearizations.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 52:1431--1441, 2001.

\bibitem[Puso and Solberg(2006)]{Puso.Solberg:2006}
M.~A. Puso and J.~Solberg.
\newblock A stabilized nodally integrated tetrahedral.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 67:841--867, 2006.

\bibitem[Scovazzi et~al.(2015)]{Scovazzi:2015}
G.~Scovazzi, B.~Carnes, X.~Zeng, and S.~Rossi.
\newblock A simple, stable, and accurate linear tetrahedral finite element for transient, nearly, and fully incompressible solid dynamics: a dynamic variational multiscale approach.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 106:799--839, 2015.

\bibitem[Simo(1992)]{Simo:1992}
J.~C. Simo.
\newblock Algorithms for static and dynamic multiplicative plasticity that preserve the classical return mapping schemes of the infinitesimal theory.
\newblock \emph{Computer Methods in Applied Mechanics and Engineering}, 99:61--112, 1992.

\bibitem[Thoutireddy et~al.(2002)]{Thoutireddy.etal:2002}
P.~Thoutireddy, J.~F. Molinari, E.~A. Repetto, and M.~Ortiz.
\newblock Tetrahedral composite finite elements.
\newblock \emph{International Journal for Numerical Methods in Engineering}, 53:1337--1351, 2002.

\bibitem[Cthonios RFE]{Cthonios:RFE}
Cthonios Organization.
\newblock \emph{ReferenceFiniteElements.jl}.
\newblock \url{https://github.com/Cthonios/ReferenceFiniteElements.jl}.

\bibitem[Cthonios FEC]{Cthonios:FEC}
Cthonios Organization.
\newblock \emph{FiniteElementContainers.jl}.
\newblock \url{https://github.com/Cthonios/FiniteElementContainers.jl}.
